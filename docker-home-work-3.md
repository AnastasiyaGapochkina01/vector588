1) Написать Dockerfile для flask приложения (код лежит тут https://github.com/AnastasiyaGapochkina01/apps/tree/main/flask-docker), собрать image и запустить его с помощью docker run
